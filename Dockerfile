...
WORKDIR /home/dst
RUN mkdir -p /home/dst/.klei server_dst/mods
...
RUN set -x && \
    ...
    chown -R dst:dst ./ && chown -R dst:dst /home/dst/.klei && chown -R dst:dst server_dst/mods && \
    # Cleanup
...
COPY ./DSTClusterConfig /home/dst/.klei/DoNotStarveTogether/DSTWhalesCluster
